...
const PaymentFailed = () => {
    ...
    const paymentError = location.state?.paymentError || "We couldn't process your payment. Please ensure your payment details are correct and try again.";
    ...
    return (
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
            <div className="bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full text-center border-t-8 border-red-500 transform transition-all hover:-translate-y-1">
                ...
                <p className="text-gray-500 mb-4 text-lg">{paymentError}</p>
                <p className="text-sm text-gray-400 mb-8">If this happened before Razorpay opened, the booking was blocked by the backend rather than the payment gateway.</p>
